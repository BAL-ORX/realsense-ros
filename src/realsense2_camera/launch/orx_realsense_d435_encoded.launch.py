...
configurable_parameters = [
    ...
    {"name": "config_file", "default": "/intel_realsense_d435_ros_config.yaml", "description": "yaml config file"},
    {"name": "encoder_config", "default": "custom", "description": "Config of encoder"},
    ...
    {"name": "depth_module.color_format", "default": "RGB8", "description": "color stream format"},
    {
...
def launch_setup(context, params, param_name_suffix=""):
    ...
    encoder_config = LaunchConfiguration("encoder_config").perform(context)
    ...
    datahub_name = params_from_file["camera_namespace"]
    camera_name = params_from_file["camera_name"]
    color_profile = params_from_file["rgb_camera"]["color_profile"]
    ...
    intel_realsense_rgb_raw_topic = f"{camera_name}/color/image_raw"
    intel_realsense_rgb_compressed_topic = f"{camera_name}/color/image_raw/h264"
    ...
    container = ComposableNodeContainer(
        ...
        composable_node_descriptions=[intel_realsense_node, encoder_node_rgb],
        output="screen",
